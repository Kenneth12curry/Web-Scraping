...
class SubscriptionService:
    ...
    def check_subscription_limits(self, username):
        ...
        try:
            query = """
                SELECT subscription_plan, requests_used, requests_limit,
            ...
            used = user_data["requests_used"]
            limit = user_data["requests_limit"]
    ...
    def reset_monthly_usage(self):
        ...
        try:
            query = "UPDATE users SET requests_used = 0"
    ...
    def upgrade_user_subscription(self, username, plan, requests_limit):
        ...
        try:
            ...
            if self.db.execute_query(query, (plan, requests_limit, end_date, username)):
                logger.info(
                    f"Abonnement mis à jour pour {username}: {plan} ({requests_limit} requêtes)"
                )
    ...
    def get_subscription_status(self, username):
        ...
        try:
            ...
            remaining = user_data["requests_limit"] - user_data["requests_used"]
            usage_percentage = (
                user_data["requests_used"] / user_data["requests_limit"]
            ) * 100
            ...
            if (
                ...
                and user_data["subscription_end_date"] < datetime.now()
            ):
                is_active = False
