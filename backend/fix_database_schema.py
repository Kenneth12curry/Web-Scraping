...
def fix_database_schema():
    ...
    try:
        ...
        try:
            mysql_connector.execute_query("ALTER TABLE users ADD COLUMN scrapedo_api_key VARCHAR(255) NULL")
            print("✅ Colonne scrapedo_api_key ajoutée")
        except Exception as e:
            print(f"(Info) Colonne scrapedo_api_key déjà existante ou erreur bénigne: {e}")
        try:
            mysql_connector.execute_query("ALTER TABLE users ADD COLUMN groq_api_key VARCHAR(255) NULL")
